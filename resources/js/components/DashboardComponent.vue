    ...
    <div class="dashboard-main">
        <div id="result">
            <div v-for="(player, index) in players" :key="index">
                <div id="'user_' + player.id " :class="player.end_time ? 'custom-container quiz-end' : 'custom-container quiz-start'">
                    <div id="circle">
                        <i v-if="player.end_time" class="fa fa-check"></i>
                    ...
                    <h1 style="margin-top:25px; ">{{ player.nick_name }}</h1>
